...
//function for centralise the all the element
function centeralise_element(element)
{
  //to centralise the element
...
//function to listen on keydown
function add_event_listener_to_rods()
{
    window.addEventListener("keydown", function (event)
    {
        let code = event.keyCode;
        //ascii value of d = 68 for right animation of rods
        if (code == 68)
        {
        ...
        // ascii value of a = 68 for left animation of rods
        else if (code == 65)
        {
            let left_numeric = parseInt(
                first_rod.style.left.substring(0, first_rod.style.left.length - 2)
...
//function for showing the score of element
function show_score()
{
